...
public class bus_bookig extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bus_bookig);
...
//        Toast.makeText(this, "FLIGHt", Toast.LENGTH_SHORT).show();
        ...
        time.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(bus_bookig.this,
        ...
        book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                utilService.hideKeyboard(view,bus_bookig.this);
...
//                    navifdsffd(view);
                ...
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
                    notification = new Notification.Builder(bus_bookig.this)
                            .setSmallIcon(R.drawable.logo)
                            .setContentText("Bus Booked Please Do Payment!!")
                            .setSubText("New Message from Travel Buddy")
                            .setChannelId(CHANNEL_ID)
                            .build();

                    notificationManager.createNotificationChannel(new NotificationChannel(CHANNEL_ID,"Bus Channel",NotificationManager.IMPORTANCE_HIGH));
                }
                else {
                    notification = new Notification.Builder(bus_bookig.this)
                            .setSmallIcon(R.drawable.logo)
...
//        Toast.makeText(Main_Payment1.this, "Reservation SFGHDFGHDSFHG", Toast.LENGTH_SHORT).show();
        ...
        String apiKey = "https://travel-buddy-api-production-8b1b.up.railway.app/api/bus";

        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST,
                apiKey, new JSONObject(params), new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                Toast.makeText(bus_bookig.this, "Bus Reservation Done", Toast.LENGTH_SHORT).show();
                try
                {
...
//                    Toast.makeText(Main_Payment1.this, "RUNTIME Reservation SFGHDFGHDSFHG", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(bus_bookig.this, Main_Payment2.class);
...
//                    throw new RuntimeException(e);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(bus_bookig.this, "Please Log In Before Booking", Toast.LENGTH_SHORT).show();
                ...
                if (error instanceof ServerError && response != null){
                    try {
                        ...
                        Toast.makeText(bus_bookig.this,obj.getString("msg"),Toast.LENGTH_SHORT).show();
