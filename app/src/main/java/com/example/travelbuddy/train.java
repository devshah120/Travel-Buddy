...
public class train extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        time.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(train.this,
        ...
        book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                utilService.hideKeyboard(view,train.this);
...
//                    navifdsffd(view);
                ...
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
                    notification = new Notification.Builder(train.this)
                            .setSmallIcon(R.drawable.logo)
                            .setContentText("Train Booked Please Do Payment!!")
                            .setSubText("New Message from Travel Buddy")
                            .setChannelId(CHANNEL_ID)
                            .build();

                    notificationManager.createNotificationChannel(new NotificationChannel(CHANNEL_ID,"Train Channel",NotificationManager.IMPORTANCE_HIGH));
                }
                else {
                    notification = new Notification.Builder(train.this)
                            .setSmallIcon(R.drawable.logo)
...
//        Toast.makeText(Main_Payment1.this, "Reservation SFGHDFGHDSFHG", Toast.LENGTH_SHORT).show();
        ...
        String apiKey = "https://travel-buddy-api-production-8b1b.up.railway.app/api/train";

        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST,
                apiKey, new JSONObject(params), new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                Toast.makeText(train.this, "Train Reservation Done", Toast.LENGTH_SHORT).show();
                try
                {
...
//                    Toast.makeText(Main_Payment1.this, "RUNTIME Reservation SFGHDFGHDSFHG", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(train.this, Main_Payment2.class);
...
//                    throw new RuntimeException(e);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(train.this, "Please Log In Before Booking", Toast.LENGTH_SHORT).show();
                ...
                if (error instanceof ServerError && response != null){
                    try {
                        ...
                        Toast.makeText(train.this,obj.getString("msg"),Toast.LENGTH_SHORT).show();
